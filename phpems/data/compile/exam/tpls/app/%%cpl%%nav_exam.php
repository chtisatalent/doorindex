<div class="row-fluid topLine">
	<div class="container-fluid">
		...
		<div class="span8">
			...
			您好（<?php echo $this->tpl_var['_user']['username']; ?>）&nbsp;&nbsp;<!--<a href="index.php?user-center"><em class="icon-user"></em> 用户中心</a><?php if($this->tpl_var['_user']['teacher_subjects']){ ?>&nbsp;&nbsp;<em class="icon-edit"></em> <a href="index.php?exam-teach">教师管理</a><?php } elseif($this->tpl_var['_user']['groupid'] == 1){ ?>&nbsp;&nbsp;<em class="icon-edit"></em> <a href="index.php?core-master">后台管理</a><?php } ?>&nbsp;&nbsp;<a class="ajax" href="index.php?user-app-logout"><em class="icon-lock"></em> 退出</a>-->			<?php } else { ?>
