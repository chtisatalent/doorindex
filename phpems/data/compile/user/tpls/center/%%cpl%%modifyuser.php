...
<div class="row-fluid">
 ...
 $fid++; ?>
										...
										<?php } ?>
											...
											<label for="usertruename" class="control-label">真实姓名：</label>
											<div class="controls">
											<input type="text"  value="<?php echo $this->tpl_var['user']['usertruename'];?>"  name="args[usertruename]" id="usertruename" />										</div>
										</div>
										
										<div class="control-group">
											<label for="usercompany" class="control-label">用户单位：</label>
											<div class="controls">
											<input type="text" value="<?php echo $this->tpl_var['user']['usercompany'];?>" name="args[usercompany]" id="usercompany" />											</div>
										</div>
										
										<div class="control-group">
											<label for="userphone" class="control-label">手机号码：</label>
											<div class="controls">
											<input type="text" value="<?php echo $this->tpl_var['user']['userphone'];?>" name="args[userphone]" id="userphone" />											</div>
										</div>
										
										<div class="control-group">
											<label for="useremail" class="control-label">电子邮箱：</label>
											<div class="controls">
											<input type="text" value="<?php echo $this->tpl_var['user']['useremail'];?>" name="args[useremail]" id="userphone" />											</div>
										</div>
