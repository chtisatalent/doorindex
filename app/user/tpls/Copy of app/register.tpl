...
<p style ="color :red;font-size:20px;">出现bug，点击"立即注册"之后，请手动刷新 之后会自动登入注册用户界面</p><p>点击“立即注册”，即表示您同意并愿意遵守本站用户协议和隐私政策，如果您已有帐号，请在此<a href="index.php?user-app-login">登录</a></p>
							</div>
						</div>
					</div>
				</fieldset>
