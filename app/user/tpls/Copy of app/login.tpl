...
<p style ="color:red;font-size:20px;">出现了bug，在输入正确用户名密码之后，请手动刷新，会进入登录后界面<br/>提供一个普通用户账号：aaa<br/>密码:111111</p><p>请输入正确的用户名和密码登录　如果您还没有帐号，请在此<a href="index.php?user-app-register">注册</a></p>
							</div>
						</div>
					</div>
				</fieldset>
