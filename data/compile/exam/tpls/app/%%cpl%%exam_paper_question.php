...
<body>
<?php $this->_compileInclude('nav_exam'); ?>
	...
	<div class="container-fluid examcontent">
		<div class="exambox" id="datacontent">
			<form class="examform form-horizontal" id="form1" name="form1" method="post" action="index.php?exam-app-exam-score">
				<ul class="breadcrumb">
					<li>
						<span class="icon-home"></span> 考场选择<span class="divider">/</span>
					</li>
					<li>
						<?php echo $this->tpl_var['data']['currentbasic']['basic']; ?><span class="divider">/</span>
					</li>
					<li>
						正式考试 <span class="divider">/</span>
					</li>
					<li class="active">
...
<div class="row-fluid">
	<div class="toolcontent">
		<div class="container-fluid footcontent">
			...
			<div class="span6">
				<ul class="unstyled">
					<li><h6>已做 <span class="yesdonumber">0</span> 题 共 <span class="allquestionnumber">50</span> 题 总分：<span class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['score']; ?></span>分  考试时间：<span class="orange"><?php echo $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['examtime']; ?></span>分钟</h6></li>
				</ul>
			</div>
			<div class="span2">
				<ul class="unstyled">
